...
<?php $relax_comment_count=1; ?>
	...
	<li class="<?php if ($comment->comment_author_email == "admin@deineseite.com") echo 'author'; else echo $oddcomment; ?> item" id="comment-<?php comment_ID() ?>">
		<div class="comment_credentials">

<?php if (function_exists('gravatar')) { ?>
<img class="cmt-gravatar" src="<?php gravatar('X', '40', get_bloginfo('template_url')."/images/avatar.gif"); ?>" alt="<?php //_e('Gravatar'); ?>" />
<?php } ?>
...
<p><span style="float:left;"><input name="submit" type="image" src="<?php bloginfo('template_directory'); ?>/images/send.gif" alt="Submit" id="submit" tabindex="5" value="Submit" />
<input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></span>
</p>
